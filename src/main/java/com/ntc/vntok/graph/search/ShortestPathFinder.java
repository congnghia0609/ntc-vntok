...
public class ShortestPathFinder {
    ...
    /**
     * Perform the Dijkstra algorithm on the graph to find minimal weights of paths from a vertex <tt>u</tt> to other
     * vertices of the graph. The weight of a path is the sum of weights on its edges. The result of this method is
     * saved to two internal private arrays. To get the minimal weight of paths from <tt>u</tt> to some vertex
     * <tt>v</tt>, use the method {@link #getWeight(int)}. To get the last spanning edge of a shortest path that leads
     * to <tt>v</tt>, use the method {@link #getSpanningEdge(int)}.
     *
    ...
    /**
     * Get a shortest path that leads to a vertex <tt>v</tt>. This method builds only a shortest path, it does not
     * examine all possible shortest paths to
    ...
    /**
     * Get all shortest paths that lead to a vertex <tt>v</tt>. A shortest path is a linked-list of nodes from vertex
     * startVertex
     *
